...
const { title: titleBook2 } = book2;
const { author: authorBook2 } = book2;
const { libraryID: libIdBook2 } = book2;

console.log(
  `The title of this book is ${titleBook2}, the author is ${authorBook2}, and the library id is ${libIdBook2}`
);
